import { STORE_NAME, TECHSTORE_BACKEND_URL } from "./constants";
...
export const submitPaymentCode = async (code: string, amount: number): Promise<SubmitCodeResponse> => {
  const payload: SubmitCodeRequest = { code, amount, storeName: STORE_NAME };
